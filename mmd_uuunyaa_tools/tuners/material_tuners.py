...
from mmd_uuunyaa_tools.tuners.material_adjusters import SubsurfaceAdjuster, WetAdjuster
...
class SkinMucosaMaterialTuner(MaterialTunerABC):
    ...
    def execute(self):
        ...
        self.edit(SubsurfaceAdjuster(self.material).attach(), {"Max": 0.400})
...
class SkinBumpMaterialTuner(MaterialTunerABC):
    ...
    def execute(self):
        ...
        self.edit(SubsurfaceAdjuster(self.material).attach(), {"Max": 0.100})
