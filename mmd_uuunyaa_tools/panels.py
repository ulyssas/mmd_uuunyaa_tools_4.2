...
from mmd_uuunyaa_tools.converters.physics.cloth import ConvertRigidBodyToClothOperator, RemoveMeshCloth, SelectClothMesh
...
from mmd_uuunyaa_tools.converters.physics.collision import RemoveMeshCollision, SelectCollisionMesh
...
class UuuNyaaPhysicsPanel(bpy.types.Panel):
    ...
    def draw(self, context: bpy.types.Context):
        ...
        if mmd_root_object is None:
            ...
            row.prop(
                mmd_root_object,
                "mmd_uuunyaa_tools_show_cloths",
                toggle=True,
                icon_only=True,
                icon="HIDE_OFF" if mmd_root_object.mmd_uuunyaa_tools_show_cloths else "HIDE_ON",
            )
