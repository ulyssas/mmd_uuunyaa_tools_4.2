...
from mmd_uuunyaa_tools.converters.armatures.mmd import MMDArmatureObject, MMDBoneType
...
class MetarigArmatureObject(ArmatureEditor):
    ...
    def fit_bones(self, mmd_armature_object: MMDArmatureObject):
        ...
        metarig_edit_bones["upper_arm.L"].roll = mmd_edit_bones[
            "左腕"
        ].roll + math.radians(+90)
        metarig_edit_bones["upper_arm.R"].roll = mmd_edit_bones[
            "右腕"
        ].roll + math.radians(+90)
        ...
        metarig_edit_bones["forearm.L"].roll = mmd_edit_bones[
            "左ひじ"
        ].roll + math.radians(+90)
        metarig_edit_bones["forearm.R"].roll = mmd_edit_bones[
            "右ひじ"
        ].roll + math.radians(+90)

        metarig_edit_bones["hand.L"].tail = mmd_edit_bones["左手首"].tail
        metarig_edit_bones["hand.R"].tail = mmd_edit_bones["右手首"].tail
        metarig_edit_bones["hand.L"].roll = mmd_edit_bones[
            "左手首"
        ].roll + math.radians(+90)
        metarig_edit_bones["hand.R"].roll = mmd_edit_bones[
            "右手首"
        ].roll + math.radians(+90)
        ...
        if MMDBoneType.THUMB_0 in mmd_armature_object.exist_bone_types:
            ...
            metarig_edit_bones["thumb.01.L"].roll = mmd_edit_bones[
                "左親指０"
            ].roll + math.radians(-90)
            metarig_edit_bones["thumb.01.R"].roll = mmd_edit_bones[
                "右親指０"
            ].roll + math.radians(-90)
        else:
            metarig_edit_bones["thumb.01.L"].head = (
                mmd_edit_bones["左親指１"].head - mmd_edit_bones["左親指１"].vector
            )
            metarig_edit_bones["thumb.01.L"].tail = mmd_edit_bones["左親指１"].head
            metarig_edit_bones["thumb.01.R"].head = (
                mmd_edit_bones["右親指１"].head - mmd_edit_bones["右親指１"].vector
            )
        ...
        metarig_edit_bones["thumb.02.L"].roll = mmd_edit_bones[
            "左親指１"
        ].roll + math.radians(-90)
        metarig_edit_bones["thumb.03.L"].roll = mmd_edit_bones[
            "左親指２"
        ].roll + math.radians(-90)
        metarig_edit_bones["thumb.02.R"].roll = mmd_edit_bones[
            "右親指１"
        ].roll + math.radians(-90)
        metarig_edit_bones["thumb.03.R"].roll = mmd_edit_bones[
            "右親指２"
        ].roll + math.radians(-90)
        ...
        if "左人指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.01.L"].roll = mmd_edit_bones[
                "左人指０"
            ].roll + math.radians(+180)
        else:
            metarig_edit_bones["palm.01.L"].head = self.to_stretch(
                mmd_edit_bones["左ひじ"].tail, mmd_edit_bones["左人指１"].head, 0.99
            )
        ...
        if "右人指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.01.R"].roll = mmd_edit_bones[
                "右人指０"
            ].roll + math.radians(+0)
        else:
            metarig_edit_bones["palm.01.R"].head = self.to_stretch(
                mmd_edit_bones["右ひじ"].tail, mmd_edit_bones["右人指１"].head, 0.99
            )
        ...
        metarig_edit_bones["f_index.01.L"].roll = mmd_edit_bones[
            "左人指１"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_index.02.L"].roll = mmd_edit_bones[
            "左人指２"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_index.03.L"].roll = mmd_edit_bones[
            "左人指３"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_index.01.R"].roll = mmd_edit_bones[
            "右人指１"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_index.02.R"].roll = mmd_edit_bones[
            "右人指２"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_index.03.R"].roll = mmd_edit_bones[
            "右人指３"
        ].roll + math.radians(+0)
        ...
        if "左中指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.02.L"].roll = mmd_edit_bones[
                "左中指０"
            ].roll + math.radians(+180)
        else:
            metarig_edit_bones["palm.02.L"].head = self.to_stretch(
                mmd_edit_bones["左ひじ"].tail, mmd_edit_bones["左中指１"].head, 0.99
            )
        ...
        if "右中指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.02.R"].roll = mmd_edit_bones[
                "右中指０"
            ].roll + math.radians(+0)
        else:
            metarig_edit_bones["palm.02.R"].head = self.to_stretch(
                mmd_edit_bones["右ひじ"].tail, mmd_edit_bones["右中指１"].head, 0.99
            )
        ...
        metarig_edit_bones["f_middle.01.L"].roll = mmd_edit_bones[
            "左中指１"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_middle.02.L"].roll = mmd_edit_bones[
            "左中指２"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_middle.03.L"].roll = mmd_edit_bones[
            "左中指３"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_middle.01.R"].roll = mmd_edit_bones[
            "右中指１"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_middle.02.R"].roll = mmd_edit_bones[
            "右中指２"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_middle.03.R"].roll = mmd_edit_bones[
            "右中指３"
        ].roll + math.radians(+0)
        ...
        if "左薬指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.03.L"].roll = mmd_edit_bones[
                "左薬指０"
            ].roll + math.radians(+180)
        else:
            metarig_edit_bones["palm.03.L"].head = self.to_stretch(
                mmd_edit_bones["左ひじ"].tail, mmd_edit_bones["左薬指１"].head, 0.99
            )
        ...
        if "右薬指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.03.R"].roll = mmd_edit_bones[
                "右薬指０"
            ].roll + math.radians(+0)
        else:
            metarig_edit_bones["palm.03.R"].head = self.to_stretch(
                mmd_edit_bones["右ひじ"].tail, mmd_edit_bones["右薬指１"].head, 0.99
            )
        ...
        metarig_edit_bones["f_ring.01.L"].roll = mmd_edit_bones[
            "左薬指１"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_ring.02.L"].roll = mmd_edit_bones[
            "左薬指２"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_ring.03.L"].roll = mmd_edit_bones[
            "左薬指３"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_ring.01.R"].roll = mmd_edit_bones[
            "右薬指１"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_ring.02.R"].roll = mmd_edit_bones[
            "右薬指２"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_ring.03.R"].roll = mmd_edit_bones[
            "右薬指３"
        ].roll + math.radians(+0)
        ...
        if "左小指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.04.L"].roll = mmd_edit_bones[
                "左小指０"
            ].roll + math.radians(+180)
        else:
            metarig_edit_bones["palm.04.L"].head = self.to_stretch(
                mmd_edit_bones["左ひじ"].tail, mmd_edit_bones["左小指１"].head, 0.99
            )
        ...
        if "右小指０" in mmd_edit_bones:
            ...
            metarig_edit_bones["palm.04.R"].roll = mmd_edit_bones[
                "右小指０"
            ].roll + math.radians(+0)
        else:
            metarig_edit_bones["palm.04.R"].head = self.to_stretch(
                mmd_edit_bones["右ひじ"].tail, mmd_edit_bones["右小指１"].head, 0.99
            )
        ...
        metarig_edit_bones["f_pinky.01.L"].roll = mmd_edit_bones[
            "左小指１"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_pinky.02.L"].roll = mmd_edit_bones[
            "左小指２"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_pinky.03.L"].roll = mmd_edit_bones[
            "左小指３"
        ].roll + math.radians(+180)
        metarig_edit_bones["f_pinky.01.R"].roll = mmd_edit_bones[
            "右小指１"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_pinky.02.R"].roll = mmd_edit_bones[
            "右小指２"
        ].roll + math.radians(+0)
        metarig_edit_bones["f_pinky.03.R"].roll = mmd_edit_bones[
            "右小指３"
        ].roll + math.radians(+0)
        ...
        if MMDBoneType.TOE_EX in mmd_armature_object.exist_bone_types:
            ...
            metarig_edit_bones["toe.L"].tail = mmd_edit_bones["左足首"].tail + Vector(
                [+0.0, -mmd_edit_bones["左足首"].length / 2, +0.0]
            )
            metarig_edit_bones["toe.R"].tail = mmd_edit_bones["右足首"].tail + Vector(
