...
class NodeEditor(ABC):
    ...
    def get_node_frame(self, label: str = None, name: str = "uuunyaa_node_frame") -> bpy.types.NodeFrame:
        return self.get_node(bpy.types.NodeFrame, label=label, name=name)

    def find_node_frame(self, label: str = None, name: str = "uuunyaa_node_frame") -> bpy.types.NodeFrame:
