...
class AutoRigArmatureObject(MMDBindArmatureObjectABC):
    ...
    prop_name_mmd_append_bind_mmd_autorig = "mmd_append_bind_mmd_autorig"
    ...
    mmd_bind_infos = [
        ...
        MMDBindInfo(MMDBoneInfo.両目, "mmd_append_eyes_fk", "mmd_append_eyes_fk", GroupType.FACE, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.左目, "mmd_append_eye_fk.l", "c_eye.l", GroupType.FACE, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.右目, "mmd_append_eye_fk.r", "c_eye.r", GroupType.FACE, MMDBindType.NONE),
        ...
        MMDBindInfo(MMDBoneInfo.左腕捩, "mmd_append_upper_arm_twist_fk.l", None, GroupType.ARM_L, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.左ひじ, "c_forearm_fk.l", "forearm.l", GroupType.ARM_L, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.左手捩, "mmd_append_wrist_twist_fk.l", None, GroupType.ARM_L, MMDBindType.NONE),
        ...
        MMDBindInfo(MMDBoneInfo.右腕捩, "mmd_append_upper_arm_twist_fk.r", None, GroupType.NONE, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.右ひじ, "c_forearm_fk.r", "forearm.r", GroupType.ARM_R, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.右手捩, "mmd_append_wrist_twist_fk.r", None, GroupType.ARM_R, MMDBindType.NONE),
        ...
        MMDBindInfo(MMDBoneInfo.左つま先ＩＫ, "mmd_append_toe_ik.l", "mmd_append_toe_ik.l", GroupType.LEG_L, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.右つま先ＩＫ, "mmd_append_toe_ik.r", "mmd_append_toe_ik.r", GroupType.LEG_R, MMDBindType.NONE),
        ...
        MMDBindInfo(MMDBoneInfo.左肩C, "mmd_append_shoulder_cancel.l", "mmd_append_shoulder_cancel.l", GroupType.NONE, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.左肩P, "mmd_append_shoulder_parent.l", "mmd_append_shoulder_parent.l", GroupType.NONE, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.右肩C, "mmd_append_shoulder_cancel.r", "mmd_append_shoulder_cancel.r", GroupType.NONE, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.右肩P, "mmd_append_shoulder_parent.r", "mmd_append_shoulder_parent.r", GroupType.NONE, MMDBindType.NONE),
        ...
        MMDBindInfo(MMDBoneInfo.左足IK親, "mmd_append_leg_ik_parent.l", "mmd_append_leg_ik_parent.l", GroupType.LEG_L, MMDBindType.NONE),
        MMDBindInfo(MMDBoneInfo.右足IK親, "mmd_append_leg_ik_parent.r", "mmd_append_leg_ik_parent.r", GroupType.LEG_R, MMDBindType.NONE),
    ]
    ...
    def __init__(self, rigify_armature_object: bpy.types.Object):
        ...
        datapaths: Dict[ControlType, DataPath] = {
            ControlType.BIND_MMD_MMD_APPEND: DataPath(self.prop_storage_bone_name, self.prop_name_mmd_append_bind_mmd_autorig),
            ControlType.EYE_MMD_MMD_APPEND: DataPath(self.prop_storage_bone_name, "mmd_append_eye_mmd_autorig"),
            ControlType.LEG_L_MMD_MMD_APPEND: DataPath(self.prop_storage_bone_name, "mmd_append_leg_l_mmd_autorig"),
            ControlType.LEG_R_MMD_MMD_APPEND: DataPath(self.prop_storage_bone_name, "mmd_append_leg_r_mmd_autorig"),
    ...
    def eye_mmd_autorig(self):
        return self._get_property(ControlType.EYE_MMD_MMD_APPEND)

    @eye_mmd_autorig.setter
    def eye_mmd_autorig(self, value):
        self._set_property(ControlType.EYE_MMD_MMD_APPEND, value)

    @property
    def leg_l_mmd_autorig(self):
        return self._get_property(ControlType.LEG_L_MMD_MMD_APPEND)

    @leg_l_mmd_autorig.setter
    def leg_l_mmd_autorig(self, value):
        self._set_property(ControlType.LEG_L_MMD_MMD_APPEND, value)

    @property
    def leg_r_mmd_autorig(self):
        return self._get_property(ControlType.LEG_R_MMD_MMD_APPEND)

    @leg_r_mmd_autorig.setter
    def leg_r_mmd_autorig(self, value):
        self._set_property(ControlType.LEG_R_MMD_MMD_APPEND, value)
    ...
    def _add_upper_arm_twist_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        ...
        upper_arm_twist_fk_l_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_upper_arm_twist_fk.l")
        self.bone_collections["Main"].assign(upper_arm_twist_fk_l_bone)
        ...
        upper_arm_twist_fk_r_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_upper_arm_twist_fk.r")
        self.bone_collections["Main"].assign(upper_arm_twist_fk_r_bone)
    ...
    def _add_wrist_twist_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        # add wrist twist (手捩)
        wrist_twist_fk_l_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_wrist_twist_fk.l")
        self.bone_collections["Main"].assign(wrist_twist_fk_l_bone)
        ...
        wrist_twist_fk_r_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_wrist_twist_fk.r")
        self.bone_collections["Main"].assign(wrist_twist_fk_r_bone)
    ...
    def _add_leg_ik_parent_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        ...
        leg_ik_parent_l_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_leg_ik_parent.l")
        self.bone_collections["Main"].assign(leg_ik_parent_l_bone)
        ...
        leg_ik_parent_r_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_leg_ik_parent.r")
        self.bone_collections["Main"].assign(leg_ik_parent_r_bone)
    ...
    def _add_toe_ik_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        ...
        self.bone_collections["Main"].assign(toe_ik_l_bone)
        toe_ik_l_bone.head = rig_edit_bones["foot.l"].tail
        toe_ik_l_bone.tail = toe_ik_l_bone.head - Vector([0, 0, rig_edit_bones["mmd_append_leg_ik_parent.l"].length])
        ...
        self.bone_collections["Main"].assign(toe_ik_r_bone)
    ...
    def _add_eye_fk_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone, bpy.types.EditBone]:
        rig_eyes_fk_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_eyes_fk")
        ...
        self.bone_collections["Main"].assign(rig_eyes_fk_bone)
        ...
        self.bone_collections["Main"].assign(rig_eye_fk_l_bone)
        ...
        self.bone_collections["Main"].assign(rig_eye_fk_r_bone)
    ...
    def _add_root_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        ...
        self.bone_collections["Main"].assign(groove_bone)
    ...
    def _add_shoulder_parent_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        shoulder_parent_l_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_parent.l")
        ...
        self.bone_collections["Main"].assign(shoulder_parent_l_bone)
        ...
        shoulder_parent_r_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_parent.r")
        ...
        self.bone_collections["Main"].assign(shoulder_parent_r_bone)
    ...
    def _add_shoulder_cancel_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        shoulder_cancel_l_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_cancel.l")
        ...
        self.bone_collections["Main"].assign(shoulder_cancel_l_bone)
        ...
        shoulder_cancel_r_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_cancel.r")
        ...
        self.bone_collections["Main"].assign(shoulder_cancel_r_bone)
    ...
    def _add_shoulder_cancel_dummy_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        shoulder_cancel_dummy_l_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_cancel_dummy.l")
        ...
        shoulder_cancel_dummy_l_bone.parent = rig_edit_bones["mmd_append_shoulder_parent.l"]
        shoulder_cancel_dummy_l_bone.roll = 0

        shoulder_cancel_dummy_r_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_cancel_dummy.r")
        ...
        shoulder_cancel_dummy_r_bone.parent = rig_edit_bones["mmd_append_shoulder_parent.r"]
    ...
    def _add_shoulder_cancel_shadow_bones(self, rig_edit_bones: bpy.types.ArmatureEditBones) -> Tuple[bpy.types.EditBone, bpy.types.EditBone]:
        shoulder_cancel_shadow_l_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_cancel_shadow.l")
        ...
        shoulder_cancel_shadow_r_bone = self.get_or_create_bone(rig_edit_bones, "mmd_append_shoulder_cancel_shadow.r")
    ...
    def imitate_mmd_pose_behavior(self):
        ...
        # shoulders
        add_constraint(
            pose_bones["mmd_append_shoulder_cancel_shadow.l"],
            "COPY_TRANSFORMS",
            "mmd_append_transform_shoulder_cancel",
            target=self.raw_object,
            subtarget="mmd_append_shoulder_cancel_dummy.l",
            target_space="POSE",
            owner_space="POSE",
        )

        add_constraint(
            pose_bones["mmd_append_shoulder_cancel_shadow.r"],
            "COPY_TRANSFORMS",
            "mmd_append_transform_shoulder_cancel",
            target=self.raw_object,
            subtarget="mmd_append_shoulder_cancel_dummy.r",
            target_space="POSE",
            owner_space="POSE",
        )

        add_constraint(
            pose_bones["mmd_append_shoulder_cancel.l"],
            "TRANSFORM",
            "mmd_append_transform_shoulder_cancel",
            target=self.raw_object,
            subtarget="mmd_append_shoulder_cancel_shadow.l",
            map_from="ROTATION",
            map_to="ROTATION",
            from_min_x_rot=math.radians(-180),
            to_min_x_rot=math.radians(+180),
            from_max_x_rot=math.radians(+180),
            to_max_x_rot=math.radians(-180),
            from_min_y_rot=math.radians(-180),
            to_min_y_rot=math.radians(+180),
            from_max_y_rot=math.radians(+180),
            to_max_y_rot=math.radians(-180),
            from_min_z_rot=math.radians(-180),
            to_min_z_rot=math.radians(+180),
            from_max_z_rot=math.radians(+180),
            to_max_z_rot=math.radians(-180),
            target_space="LOCAL",
            owner_space="LOCAL",
        )

        add_constraint(
            pose_bones["mmd_append_shoulder_cancel.r"],
            "TRANSFORM",
            "mmd_append_transform_shoulder_cancel",
            target=self.raw_object,
            subtarget="mmd_append_shoulder_cancel_shadow.r",
            map_from="ROTATION",
            map_to="ROTATION",
            from_min_x_rot=math.radians(-180),
            to_min_x_rot=math.radians(+180),
        ...
        pose_bones["mmd_append_upper_arm_twist_fk.l"].lock_rotation_w = False
        pose_bones["mmd_append_upper_arm_twist_fk.l"].lock_rotation = [True, False, True]

        pose_bones["mmd_append_upper_arm_twist_fk.r"].lock_location = [True, True, True]
        pose_bones["mmd_append_upper_arm_twist_fk.r"].lock_rotation_w = False
        pose_bones["mmd_append_upper_arm_twist_fk.r"].lock_rotation = [True, False, True]

        # wrists
        pose_bones["mmd_append_wrist_twist_fk.l"].lock_location = [True, True, True]
        pose_bones["mmd_append_wrist_twist_fk.l"].lock_rotation_w = False
        pose_bones["mmd_append_wrist_twist_fk.l"].lock_rotation = [True, False, True]

        pose_bones["mmd_append_wrist_twist_fk.r"].lock_location = [True, True, True]
        pose_bones["mmd_append_wrist_twist_fk.r"].lock_rotation_w = False
        pose_bones["mmd_append_wrist_twist_fk.r"].lock_rotation = [True, False, True]

        leg_l_mmd_append_data_path = f"pose.bones{self.datapaths[ControlType.LEG_L_MMD_MMD_APPEND].data_path}"
        leg_r_mmd_append_data_path = f"pose.bones{self.datapaths[ControlType.LEG_R_MMD_MMD_APPEND].data_path}"

        # legs
        add_constraint(
            pose_bones["thigh_ik_nostr.l"],
            "COPY_ROTATION",
            "mmd_append_copy_rotation",
            target=self.raw_object,
            subtarget="c_thigh_ik.l",
        )
        shin_ik_l_bone = pose_bones["leg_ik_nostr.l"]
        for constraint in list_constraints(pose_bones["leg_ik_nostr.l"], "IK"):
            self.add_influence_driver(constraint, self.raw_object, leg_l_mmd_append_data_path)
        self.add_ik_constraint(
            shin_ik_l_bone,
            self.raw_object,
            "foot_ik_target.l",
            2,
            200,
            leg_l_mmd_append_data_path,
        ...
        add_constraint(
            pose_bones["thigh_ik_nostr.r"],
            "COPY_ROTATION",
            "mmd_append_copy_rotation",
            target=self.raw_object,
            subtarget="c_thigh_ik.r",
        )
        shin_ik_r_bone = pose_bones["leg_ik_nostr.r"]
        for constraint in list_constraints(pose_bones["leg_ik_nostr.r"], "IK"):
            self.add_influence_driver(constraint, self.raw_object, leg_r_mmd_append_data_path)
        self.add_ik_constraint(
            shin_ik_r_bone,
            self.raw_object,
            "foot_ik_target.r",
        ...
        def add_bone_hide_driver(pose_bone: bpy.types.PoseBone, leg_ik_fk_data_path: str, leg_mmd_append_data_path: str):
            ...
            leg_ik_fk_variable.name = "mmd_append_leg_ik_fk"
            leg_ik_fk_variable.targets[0].id = self.raw_object
            leg_ik_fk_variable.targets[0].data_path = leg_ik_fk_data_path
            leg_mmd_append_variable: bpy.types.DriverVariable = driver.variables.new()
            leg_mmd_append_variable.name = "leg_mmd_append"
            leg_mmd_append_variable.targets[0].id = self.raw_object
            leg_mmd_append_variable.targets[0].data_path = leg_mmd_append_data_path

            driver.expression = f"(1-{leg_ik_fk_variable.name})*{leg_mmd_append_variable.name}"
        ...
        add_bone_hide_driver(pose_bones["c_leg_pole.l"], leg_l_ik_fk_data_path, leg_l_mmd_append_data_path)
        add_bone_hide_driver(pose_bones["c_leg_pole.r"], leg_r_ik_fk_data_path, leg_r_mmd_append_data_path)
        ...
        # toe IK
        leg_l_mmd_append = self.datapaths[ControlType.LEG_L_MMD_MMD_APPEND]
        leg_r_mmd_append = self.datapaths[ControlType.LEG_R_MMD_MMD_APPEND]
        self.add_ik_constraint(
            pose_bones["foot.l"],
            self.raw_object,
            "mmd_append_toe_ik.l",
            1,
            3,
            f"pose.bones{leg_l_mmd_append.data_path}",
            invert_influence=True,
        )
        self.add_ik_constraint(
            pose_bones["foot.r"],
            ...
            1,
            3,
            f"pose.bones{leg_r_mmd_append.data_path}",
            invert_influence=True,
        )
    ...
    def _set_bone_custom_shapes(self, pose_bones: Dict[str, bpy.types.PoseBone]):
        bone_widgets = [
            ...
            ("mmd_append_shoulder_parent.l", "WGT-rig_upper_arm_tweak.L", 0.5, "body.l"),
            ("mmd_append_shoulder_parent.r", "WGT-rig_upper_arm_tweak.R", 0.5, "body.r"),
            ("mmd_append_upper_arm_twist_fk.l", "WGT-rig_upper_arm_fk.L", 1.0, "body.l"),
            ("mmd_append_upper_arm_twist_fk.r", "WGT-rig_upper_arm_fk.R", 1.0, "body.r"),
            ("mmd_append_wrist_twist_fk.l", "WGT-rig_forearm_fk.L", 1.0, "body.l"),
            ("mmd_append_wrist_twist_fk.r", "WGT-rig_forearm_fk.R", 1.0, "body.r"),
            ("mmd_append_leg_ik_parent.l", "WGT-Bowl.Horizontal.001", 20.0, "body.l"),
            ("mmd_append_leg_ik_parent.r", "WGT-Bowl.Horizontal.001", 20.0, "body.r"),
            ("mmd_append_toe_ik.l", "WGT-Visor.Wide", 1.0, "body.l"),
            ("mmd_append_toe_ik.r", "WGT-Visor.Wide", 1.0, "body.r"),
        ]
        ...
        for bone_name, custom_shape_name, custom_shape_scale, _bone_group_name in bone_widgets:
            ...
            self.bone_collections["Main"].assign(pose_bones[bone_name])
            # pose_bones[bone_name].bone_group = rig_bone_groups[bone_group_name]

        if not self.has_face_bones():
            return

        self.bone_collections["Main"].assign(pose_bones["mmd_append_eyes_fk"])
        self.bone_collections["Main"].assign(pose_bones["mmd_append_eye_fk.l"])
        self.bone_collections["Main"].assign(pose_bones["mmd_append_eye_fk.r"])
        # pose_bones["mmd_append_eyes_fk"].bone_group = rig_bone_groups["body.x"]
        # pose_bones["mmd_append_eye_fk.l"].bone_group = rig_bone_groups["body.l"]
        # pose_bones["mmd_append_eye_fk.r"].bone_group = rig_bone_groups["body.r"]
    ...
    def _imitate_mmd_eye_behavior(self, pose_bones: Dict[str, bpy.types.PoseBone]):
        ...
        self._add_eye_constraints(
            pose_bones["c_eye.l"],
            pose_bones["c_eye.r"],
            pose_bones["mmd_append_eye_fk.l"],
            pose_bones["mmd_append_eye_fk.r"],
            pose_bones["mmd_append_eyes_fk"],
        )

        eye_mmd_append_data_path = f"pose.bones{self.datapaths[ControlType.EYE_MMD_MMD_APPEND].data_path}"
        ...
        update_influence_drivers(pose_bones["c_eye.l"], eye_mmd_append_data_path, invert_influence=True)
        update_influence_drivers(pose_bones["c_eye.r"], eye_mmd_append_data_path, invert_influence=True)
    ...
    def pose_mmd_rest(self, dependency_graph: bpy.types.Depsgraph, iterations: int, pose_arms: bool, pose_legs: bool, pose_fingers: bool):
        ...
        for _ in range(iterations):
            ...
            if pose_legs:
                # foot.L
                if "mmd_append_leg_ik_parent.l" in pose_bones:
                    pose_bones["mmd_append_leg_ik_parent.l"].location.x += pose_bones["thigh.l"].head[0] - pose_bones["foot.l"].head[0]
                else:
                    pose_bones["c_foot_ik.l"].location.x += pose_bones["thigh.l"].head[0] - pose_bones["c_foot_ik.l"].head[0]

                pose_bones["c_thigh_b.l"].rotation_euler.y -= math.radians(180) + math.atan2(*pose_bones["c_thigh_b.l"].x_axis[0:2])
                pose_bones["c_foot_ik.l"].matrix = pose_bones["c_foot_ik.l"].matrix @ Matrix.Rotation(math.radians(180) + pose_bones["foot.l"].matrix.to_euler().z, 4, "Z")
                pose_bones["c_leg_pole.l"].location.x += pose_bones["thigh.l"].head[0] - pose_bones["c_leg_pole.l"].head[0]

                # foot.R
                if "mmd_append_leg_ik_parent.r" in pose_bones:
                    pose_bones["mmd_append_leg_ik_parent.r"].location.x += pose_bones["thigh.r"].head[0] - pose_bones["foot.r"].head[0]
                else:
                    pose_bones["c_foot_ik.r"].location.x += pose_bones["thigh.r"].head[0] - pose_bones["c_foot_ik.r"].head[0]

                pose_bones["c_thigh_b.r"].rotation_euler.y -= math.radians(0) + math.atan2(*pose_bones["c_thigh_b.r"].x_axis[0:2])
                pose_bones["c_foot_ik.r"].matrix = pose_bones["c_foot_ik.r"].matrix @ Matrix.Rotation(math.radians(180) + pose_bones["foot.r"].matrix.to_euler().z, 4, "Z")
                pose_bones["c_leg_pole.r"].location.x += pose_bones["thigh.r"].head[0] - pose_bones["c_leg_pole.r"].head[0]

            if pose_fingers:
                # finger.L
                target_rotation = to_rotation_matrix(pose_bones["c_middle1.l"])
                for bone_name in [
                    "c_index1.l",
                    "c_index2.l",
                    "c_index3.l",
