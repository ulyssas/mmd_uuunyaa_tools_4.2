...
class MMDRigifyPanel(bpy.types.Panel):
    ...
    def draw(self, context: bpy.types.Context):
        ...
        bind_mmd_rigify = rigify_armature_object.datapaths[ControlType.BIND_MMD_MMD_APPEND]
        eye_mmd_rigify = rigify_armature_object.datapaths[ControlType.EYE_MMD_MMD_APPEND]
        leg_l_mmd_rigify = rigify_armature_object.datapaths[ControlType.LEG_L_MMD_MMD_APPEND]
        leg_r_mmd_rigify = rigify_armature_object.datapaths[ControlType.LEG_R_MMD_MMD_APPEND]
        toe_l_mmd_rigify = rigify_armature_object.datapaths[ControlType.TOE_L_MMD_MMD_APPEND]
        toe_r_mmd_rigify = rigify_armature_object.datapaths[ControlType.TOE_R_MMD_MMD_APPEND]
...
class AutoRigPanel(bpy.types.Panel):
    ...
    def draw(self, context: bpy.types.Context):
        ...
        eye_mmd_autorig = autorig_armature_object.datapaths[ControlType.EYE_MMD_MMD_APPEND]
        leg_l_mmd_autorig = autorig_armature_object.datapaths[ControlType.LEG_L_MMD_MMD_APPEND]
        leg_r_mmd_autorig = autorig_armature_object.datapaths[ControlType.LEG_R_MMD_MMD_APPEND]
