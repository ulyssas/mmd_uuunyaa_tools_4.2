...
class ControlType(Enum):
    EYE_MMD_MMD_APPEND = "eye_mmd_append"
    BIND_MMD_MMD_APPEND = "bind_mmd_append"
    LEG_L_MMD_MMD_APPEND = "leg_l_mmd_append"
    LEG_R_MMD_MMD_APPEND = "leg_r_mmd_append"
    TOE_L_MMD_MMD_APPEND = "toe_l_mmd_append"
    TOE_R_MMD_MMD_APPEND = "toe_r_mmd_append"
...
class MMDBindArmatureObjectABC(ArmatureEditor, PoseBoneEditor):
    ...
    def create_props(self, prop_storage_bone: bpy.types.PoseBone):
        for control_type in [
            ControlType.BIND_MMD_MMD_APPEND,
            ControlType.EYE_MMD_MMD_APPEND,
            ControlType.LEG_L_MMD_MMD_APPEND,
            ControlType.LEG_R_MMD_MMD_APPEND,
            ControlType.TOE_L_MMD_MMD_APPEND,
            ControlType.TOE_R_MMD_MMD_APPEND,
        ]:
    ...
    def _add_eye_constraints(
        ...
        self.add_copy_rotation_constraint(target_eye_l_bone, self.raw_object, control_eye_l_bone.name, "LOCAL", eye_mmd_append_data_path, invert_influence=True)
        self.add_copy_rotation_constraint(target_eye_r_bone, self.raw_object, control_eye_r_bone.name, "LOCAL", eye_mmd_append_data_path, invert_influence=True)
        self.add_copy_rotation_constraint(
            control_eye_l_bone,
            self.raw_object,
            control_eyes_bone.name,
            "LOCAL",
            eye_mmd_append_data_path,
