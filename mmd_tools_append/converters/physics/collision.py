...
class MMDAppendCollisionAdjusterPanel(bpy.types.Panel):
    ...
    def draw(self, context: bpy.types.Context):
        ...
        collision_settings = mesh_object.mmd_tools_append_collision_settings
...
class CopyCollisionAdjusterSettings(bpy.types.Operator):
    ...
    def execute(self, context: bpy.types.Context):
        ...
        from_settings = from_object.mmd_tools_append_collision_settings
        ...
        for to_object in context.selected_objects:
            ...
            to_settings = to_object.mmd_tools_append_collision_settings
...
class SelectCollisionMesh(bpy.types.Operator):
    ...
    def execute(self, context: bpy.types.Context):
        ...
        key_settings = key_object.mmd_tools_append_collision_settings
        ...
        for obj in self.filter_only_in_mmd_model(key_object) if self.same_mmd_model else bpy.data.objects:
            ...
            if self.same_physics_settings and not key_settings.physics_equals(obj.mmd_tools_append_collision_settings):
                continue
...
class CollisionAdjusterSettingsPropertyGroup(bpy.types.PropertyGroup):
    ...
    def register():
        ...
        bpy.types.Object.mmd_tools_append_collision_settings = bpy.props.PointerProperty(type=CollisionAdjusterSettingsPropertyGroup)

    @staticmethod
    def unregister():
        del bpy.types.Object.mmd_tools_append_collision_settings
