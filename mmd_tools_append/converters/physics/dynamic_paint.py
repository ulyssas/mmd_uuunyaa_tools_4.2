...
class MMDAppendDynamicPaintAdjuster(bpy.types.Panel):
    ...
    def draw(self, context: bpy.types.Context):
        ...
        dynamic_paint_settings = mesh_object.mmd_tools_append_dynamic_paint_settings
...
class DynamicPaintAdjusterSettingsPropertyGroup(bpy.types.PropertyGroup):
    ...
    def register():
        ...
        bpy.types.Object.mmd_tools_append_dynamic_paint_settings = bpy.props.PointerProperty(type=DynamicPaintAdjusterSettingsPropertyGroup)

    @staticmethod
    def unregister():
        del bpy.types.Object.mmd_tools_append_dynamic_paint_settings
