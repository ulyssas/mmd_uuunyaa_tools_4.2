...
class AssetSearch(bpy.types.Operator):
    bl_idname = "mmd_tools_append.asset_search"
    ...
    def execute(self, context):
        ...
        query = context.scene.mmd_tools_append_asset_search.query
        ...
        result = context.scene.mmd_tools_append_asset_search.result
...
class AssetDownload(bpy.types.Operator):
    bl_idname = "mmd_tools_append.asset_download"
...
class AssetDownloadCancel(bpy.types.Operator):
    bl_idname = "mmd_tools_append.asset_download_cancel"
...
class AssetCacheRemove(bpy.types.Operator):
    bl_idname = "mmd_tools_append.asset_cache_remove"
...
class AssetImport(bpy.types.Operator):
    bl_idname = "mmd_tools_append.asset_import"
...
class AssetDetailPopup(bpy.types.Operator):
    bl_idname = "mmd_tools_append.asset_detail_popup"
...
class AssetSearchQueryTags(bpy.types.UIList):
    bl_idname = "MMD_APPEND_UL_mmd_tools_append_asset_search_query_tags"
...
class AssetSearchPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        search = context.scene.mmd_tools_append_asset_search
        query = search.query
        layout = self.layout
        ...
        asset_items = context.scene.mmd_tools_append_asset_search.result.asset_items
...
class AssetsOperatorPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        props = context.scene.mmd_tools_append_asset_operator
